 ...
 */
@Autonomous(name = "Auto for Red")
public class MecAutoRed extends LinearOpMode {
    DcMotor LF;
    DcMotor RF;
    DcMotor LB;
    DcMotor RB;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(opModeIsActive()){
            ShootBall();
            encoderDrive(driveSpeed, 24.0, -24.0, -24.0, 24.0);
            encoderDrive(driveSpeed, Math.sqrt(8.0), 0.0, 0.0, Math.sqrt(8.0));
            encoderDrive(driveSpeed, ninetyRotation, -ninetyRotation, ninetyRotation, -ninetyRotation);
            encoderDrive(driveSpeed, 24.0, -24.0, -24.0, 24.0);
            pushButton("red");
            Thread.sleep(1000);
            encoderDrive(driveSpeed, 24.0, -24.0, -24.0, 24.0);
