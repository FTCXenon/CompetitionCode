 ...
 */
@TeleOp(name = "For One")
public class OnePersonMecanum extends LinearOpMode {
    DcMotor LF;
    DcMotor RF;
    DcMotor LB;
    DcMotor RB;
...
//Check if need to scale -- if not set to 1 to nullify scale
            ...
            if (gamepad1.right_trigger > 0.2) {
                ballShooterLeft.setPower(.75);
                ballShooterRight.setPower(-.75);
            ...
            if (gamepad1.a) intakeServo.setPower(1.0);
            else intakeServo.setPower(0.0);
            if (gamepad1.b) intakeServo.setPower(-1.0);
            else intakeServo.setPower(0.0);
